  ...
  return (
    <div className="flex items-center justify-center bg-neutral-100 px-8 py-24 text-neutral-800">
      <BlockInTextCard
        ...
        examples={[
          "Let's Build Impactful Tech Communities Together",
          "Driven by Passion. Powered by Purpose.",
          "Fueled by Curiosity, Focused on Community",
          "Empowering innovation through tech, community, and leadership",
        ]}
      />
    </div>
  );
